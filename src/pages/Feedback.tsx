                    ...
                    {!submittedRating ? (
                        <>
                            <div className='flex flex-col items-center w-full'>
                                <h1 className='text-neutral-900 text-5xl tracking-widest pb-15'>How was your experience?</h1>
                                <textarea 
                                    value={feedbackMessage}
                                    onChange={handleChange}
                                    placeholder='We would love to hear feedback from our verified customers'
