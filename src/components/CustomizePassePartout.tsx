    ...
    return (
        <div className='flex flex-col min-h-svh min-sm:h-svh w-full'>
            <div className='flex flex-col pt-15 pb-8 px-4'>
                <h1 className='text-neutral-900 self-center text-2xl font-bold tracking-tight'>Choose a Passepartout</h1>
                <p className='text-md text-neutral-500 text-center font-normal mt-2'>Add a passepartout to enhance your frame</p>
            </div>
