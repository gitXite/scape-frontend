...
function BackButton({ page }: BackButtonProps) {
    ...
    return (
        <button 
            className='flex group items-center font-medium fixed m-10 top-0 left-0 mt-9 h-fit text-lg transition-colors duration-100 text-neutral-600 hover:text-neutral-950 hover:cursor-pointer active:text-neutral-600'
            onClick={() => {
