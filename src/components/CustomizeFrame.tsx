    ...
    return (
        <div className='flex flex-col w-full'>
            <div className='flex flex-col pt-5 pb-8 px-4'>
                <h1 className='text-foreground self-center text-2xl font-bold tracking-tight'>Choose a Frame</h1>
                <p className='text-md text-muted-foreground font-normal text-center mt-2'>Select the perfect frame for your scape</p>
            </div>
            <div className='flex max-lg:flex-col w-full max-lg:px-10 max-lg:place-content-between place-content-evenly max-lg:items-center sm:mb-10'>
                <div className='flex h-[60vh] max-sm:h-[300px] w-1/3 max-lg:w-full rounded-2xl bg-background border border-border shadow-sm'>
