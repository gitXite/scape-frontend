...
function FrameCard({
    ...
    return (
        <label className='flex flex-col h-fit cursor-pointer w-40 max-md:w-35 z-5'>
            ...
            />
            <div className='flex flex-col h-58 w-40 max-md:w-35 max-md:h-48 text-center justify-between bg-neutral-200/20 hover:bg-white items-center peer-checked:bg-white border rounded-sm p-4 transition peer-checked:border-neutral-900 peer-checked:scale-105 peer-checked:shadow-lg hover:scale-105 hover:shadow-lg'>
                {isSelected && (
