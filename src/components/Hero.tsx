        ...
        <div id='home' className='h-svh w-full place-content-center'>
            <div className='flex flex-col place-items-center place-content-center h-full w-full shadow-[inset_0px_0px_20px_rgba(0,0,0,0.6)] bg-gradient-to-br from-neutral-900 via-[hsl(225,50%,6%)] to-neutral-900 drop-shadow-xl drop-shadow-neutral-500/60 overflow-hidden'>
                ...
                <div className='flex flex-col absolute bottom-20 max-sm:bottom-10'>
                    ...
                    >
                        <button
                            className='flex z-2 px-10 py-4 max-sm:px-8 max-sm:py-3.5 text-md sm:text-lg md:tracking-normal font-normal group transition-colors backdrop-blur-md hover:bg-neutral-200/30 text-neutral-900 border-1 border-neutral-200/50 rounded-full shadow-md hover:cursor-pointer'
                            onClick={() => {
