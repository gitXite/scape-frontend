...
function Hero() {
    ...
    return (
        <div id='home' className='h-full w-full place-content-center'>
            <div className='flex flex-col place-items-center place-content-center h-8/12 w-full shadow-[inset_0px_0px_20px_rgba(0,0,0,0.6)] bg-neutral-900 drop-shadow-xl drop-shadow-neutral-500/60'>
                <VideoBackground />
            ...
            <div className='flex flex-col text-center items-center'>
                <a href='#thescape' className='text-lg text-neutral-500 relative top-10 cursor-pointer font-normal hover:text-neutral-600 active:text-neutral-500 transition-colors duration-100 pb-5 z-1 peer'>Read More</a>
